...
public class Drive extends Subsystem {
    ...
    private Encoder eastEncoder;
    private Encoder westEncoder;
    ...
    public Drive() {
        ...
        //and west is left and counterclockwise
    ...
    public double getLeftEncoder(){
        if(Robot.flipped == false){
            westEncoder.setReverseDirection(true);
            double dist;
            dist = westEncoder.getDistance();
            return dist;
        }else if(Robot.flipped == true){
            eastEncoder.setReverseDirection(true);
            double dist;
            dist = eastEncoder.getDistance();
            return dist;
        }else {
            System.out.println("flipped is null");
            return 0;
        }
    ...
    public double getRightEncoder(){
        if(Robot.flipped == false){
            eastEncoder.setReverseDirection(false);
            double dist;
            dist = eastEncoder.getDistance();
            return dist;
        }else if(Robot.flipped == true){
